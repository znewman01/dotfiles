      ...
      `(("nw" "Work"
           ((agenda ""
            ...
            (org-ql-block '(and
                          ...
                          ((org-super-agenda-groups '((:discard (:not (:tag "chainguard")))
                                                      (:discard (:time-grid t))
                                                      (:name "Overdue:"
                                                             :deadline past)
                                                      (:name "Upcoming:"
         ...
         (org-ql-block '(and
                         ...
                         (or (and (todo "PROJ")
                             ...
                             (and (todo "BLOCKEDPROJ")
                                  (not (scheduled t)))))
                         ((org-ql-block-header "Stuck projects:")))
          (org-ql-block '(or (and (todo "NEXT") (not (tags "SOMEDAY")))
                             (and (deadline auto) (not (done)))
                             (and (scheduled :to today :with-time nil) (not (done))))
