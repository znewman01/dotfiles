...
Make the ~doom~ CLI tool work (hack because I :
#+begin_src emacs-lisp
...
(setq mu4e-contexts
      `(
        ...
        ,(make-mu4e-context
          ...
          :vars '((mu4e-trash-folder . "/csail/INBOX..Trash")
                  (mu4e-sent-folder . "/csail/INBOX..Sent")
                  (mu4e-drafts-folder . "/csail/INBOX..Drafts")
                  (mu4e-refile-folder . "/csail/INBOX..Archive")
